...
describe('detectArtifactType', () => {
  describe('HTML detection', () => {
    it('detects pytest-html by content', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'html/pytest-html-sample.html'));
    ...
    it('detects playwright-html by content', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'html/playwright-html-sample.html'));
  ...
  describe('JSON detection', () => {
    it('detects playwright JSON by structure', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'json/playwright-json-sample.json'));
    ...
    it('detects pytest JSON by structure', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'json/pytest-json-sample.json'));
  ...
  describe('XML detection', () => {
    it('detects JUnit XML by content', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'xml/junit-sample.xml'));
  ...
  describe('Text detection', () => {
    ...
    it('detects flake8 output by pattern', () => {
      const result = detectArtifactType(join(FIXTURES_DIR, 'txt/flake8-sample.txt'));
